...
Run code:
```
cargo r --release --example rt-the-next-week_8_2
```
...
---
![](./docs/assets/rt-the-next-week_4.6.png)
...
---
![](./docs/assets/rt-the-next-week_8.2.png)
*Ray Tracing: The Next Week. Chapter 8.2*
